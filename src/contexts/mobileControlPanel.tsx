...
export const mobileContolPanelContext = createContext<mobileContolPanelData>(mobileContolPanelDataDefault);
...
const MobileContolPanelProvider = ({children}:mobileContolPanelProps) =>{
  ...
  return <mobileContolPanelContext.Provider value={mobileContolPanelDynamicData}>
    {children}
