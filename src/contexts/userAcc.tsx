...
export const userAccContext = createContext<{user: userAcc, setUser: (payload: userAcc)=> void}>(userAccDefaultData);
...
const UserAccProvider = ({children}: userAccProps) => {
  ...
  return <userAccContext.Provider value={userAccDynamicData}>
    {children}
