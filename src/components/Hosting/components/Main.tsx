...
function Main(): JSX.Element {
    ...
    const [refButton, inViewButton] = useInView({ // Kích hoạt nhiều lần khi vào khung nhìn
                ...
                <div className='w-[100%] py-[64px]'>
                    <div className=''>
                        ...
                        <motion.div
                            ...
                            whileInView="onscreen"
                            viewport={{ amount: 0.5 }}
                            className='bg-[#F7F7F7] h-[200px] flex items-center justify-center rounded-[12px]'>
                            <div>
            ...
            <div className='w-[100%] px-[80px] mobile:px-0 flex flex-col gap-3 mt-[64px]'>
                <div>
                    <motion.h1
                        ...
                        whileInView="onscreen"
                        viewport={{ amount: 0.5 }}
                        className='text-[26px] font-semibold mb-3'>We’re here to help</motion.h1>
