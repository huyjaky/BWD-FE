...
import { categoriesStep2, categoriesStep9, safetyitems, standoutamenities } from '../utils/constant';
                ...
                <div className='flex flex-col px-10 w-[100%]' >
                    <div className='mb-[32px]'>
                        <div className='mb-[32px] h-[82px] tablet:mb-[62px] mobile:mb-[152px] w-[100%] ml-auto mr-auto '>
                            <h1 className='text-[32px] font-semibold w-[100%] leading-10 mb-3 
                        '>Tell guests what your place has to offer</h1>
                            <p className='text-[18px] text-[#717171]'>You can add more amenities after you publish your listing.</p>
                        </div>
                        <div className='grid grid-cols-3 gap-[15px] w-[110%]
                                    laptop:grid-cols-2
                                    tablet:grid-cols-2
                                    mobile:grid-cols-1
                    '>
                    ...
                    <div className='mb-[22px]'>
                        <div className='h-[24px] mb-[22px] tablet:mb-[62px] mobile:mb-[92px] w-[100%]  ml-auto mr-auto '>
                            <p className='text-[18px] text-black font-semibold'>Do you have any standout amenities?</p>
                        </div>
                        <div className='grid grid-cols-3 gap-[15px] w-[110%]
                                    laptop:grid-cols-2
                                    tablet:grid-cols-2
