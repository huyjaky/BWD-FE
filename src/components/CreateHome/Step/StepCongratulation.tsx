                ...
                <div className="w-[50%]">
                    <div className="w-[100%]">
                        <div className="w-[50%] mobile:w-[100%] h-fit flex mobile:flex-col mobile:justify-center mobile:items-center">
                            <h1 className="text-[48px] z-10 tablet:text-[36px] mobile:text-[36px] ">
                        ...
                        <p className="text-[14px] z-10 relative tablet:text-[13px] mobile:text-[13px]  mt-[12px]">
                            From one Host to another—welcome aboard. Thank you for sharing your home and helping
                            to create incredible experiences for our guests.
                        </p>
                    </div>
