...
const ChooTypeHo: React.FC<ChooTypeHoProps> = ({ name, icon, description, selected, setselected }) => {
    ...
    return (
        <button className='w-[100%] mb-3 border-[2px] border-[rgb(221,221,221) rounded-[12px] hover:border-[2px] hover:border-black'
